...
• You can now use !join [game] [mode] [skill] without specifying a team and the bot will automatically add you the the first available team.  
  (It takes available slots and kicks into account)  
